...
import { updateGeneralExpense, type ExpenseFormState } from '@/lib/actions';
...
export function EditGeneralExpenseButton({ expense, campaignId, actionId }: { expense: Expense, campaignId: string; actionId: string; }) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent onClick={stopPropagation}>
                <DialogHeader>
                    <DialogTitle>Редактировать общий расход</DialogTitle>
                </DialogHeader>
