...
export function EditActionResponsibilityButton({ action, campaignId, asChild = false }: { action: Action, campaignId: string, asChild?: boolean }) {
    ...
    const initialState: ResponsibilityFormState = { message: "", errors: {} };
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[625px]">
                <DialogHeader>
                    <DialogTitle>Редактировать ответственных</DialogTitle>
                    <DialogDescription>
                        Измените информацию об ответственных лицах для акции.
                    </DialogDescription>
                </DialogHeader>
