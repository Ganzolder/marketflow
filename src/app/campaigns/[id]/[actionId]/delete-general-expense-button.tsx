...
import { deleteGeneralExpense, type DeleteFormState } from '@/lib/actions';
...
export function DeleteGeneralExpenseButton({ expenseId, campaignId, actionId }: { expenseId: string, campaignId: string, actionId: string }) {
    const [open, setOpen] = useState(false);
    const { toast } = useToast();
    
    const initialState: DeleteFormState = { message: "", error: false };
    const [state, dispatch] = useActionState(deleteGeneralExpense, initialState);
