...
import type { Campaign, Task, SocialPost } from '@/lib/types';
...
export function OverallAiAnalyzerButton({ campaigns, tasks, posts }: { campaigns: Campaign[], tasks: Task[], posts: SocialPost[] }) {
    ...
    const handleAnalysis = async () => {
        ...
        const result = await analyzeOverallPerformance({ campaigns, tasks, posts });
        setState(result);
